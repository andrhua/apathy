...
public class Sprite {
    ...
    public Sprite(Object image, int fpl, int border, int totalFrames) {
        Tile[] frames = null;
        this.fpl = fpl;
        borderWidth = border;
        ...
        frameSize.width = 0 / (fpl + borderWidth * fpl);
        frameSize.height = (int) (0 / (Math.ceil(totalFrames / fpl) + Math.ceil(totalFrames / fpl) * borderWidth));
