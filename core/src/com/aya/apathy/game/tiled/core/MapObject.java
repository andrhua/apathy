...
public class MapObject implements Cloneable {
    ...
    private Object scaledImage;
    private int id;
    private float angle;

    public MapObject(int id, float x, float y, float width, float height, float angle) {
    ...
    public void setImageSource(String source) {
        ...
        if (imageSource.length() > 0) {
            image = new Object();//BitmapFactory.decodeFile(imageSource);
        } else {
            image = null;
        }
     ...
     */
    public Object getImage(double zoom) {
        if (image == null)
            return null;
        ...
        if (scaledImage == null || 0 != zoomedWidth
                || 0 != zoomedHeight) {
            scaledImage = new Object();
            //Bitmap.createScaledBitmap(image, zoomedWidth, zoomedHeight, true);
        }
