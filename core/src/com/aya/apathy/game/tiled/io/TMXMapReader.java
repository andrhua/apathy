...
package com.aya.apathy.game.tiled.io;

import com.aya.apathy.game.tiled.core.AnimatedTile;
...
import com.aya.apathy.game.tiled.core.Tile;
import com.aya.apathy.game.tiled.core.TileLayer;
import com.aya.apathy.game.tiled.core.TileSet;
import com.aya.apathy.game.tiled.util.Base64;
...
public class TMXMapReader {
    ...
    private Object unmarshalImage(Node t, String baseDir) throws IOException {
        Object img = null;
        ...
        if (source != null) {
            ...
            img = new Object();// BitmapFactory.decodeFile(source);
        } else {
            ...
            for (int i = 0; i < nl.getLength(); i++) {
                ...
                if ("data".equals(node.getNodeName())) {
                    ...
                    if (cdata != null) {
                        ...
                        img = new Object();//BitmapFactory.decodeByteArray(imageData, 0, imageData.length);
                    }
                    break;
                }
            }
    ...
    private MapObject readMapObject(Node t) throws Exception {
        ...
        final float x = getAttribute(t, "x", 0);
        final float y = getAttribute(t, "y", 0);
        final float width = getAttribute(t, "width", 0);
        final float height = getAttribute(t, "height", 0);
    ...
    private Tile unmarshalTile(TileSet set, Node t, String baseDir)
        ...
        for (int i = 0; i < children.getLength(); i++) {
            ...
            if ("image".equalsIgnoreCase(child.getNodeName())) {
                ...
                Object img = unmarshalImage(child, baseDir);
                tile.setImage(img);
    ...
    private MapLayer readLayer(Node t) throws Exception {
        final int layerWidth = getAttribute(t, "width", (int)map.getWidth());
        final int layerHeight = getAttribute(t, "height", (int)map.getHeight());
