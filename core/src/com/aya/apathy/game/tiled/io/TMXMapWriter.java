...
import com.aya.apathy.game.tiled.core.Sprite;
...
import com.aya.apathy.game.tiled.io.xml.XMLWriter;
            ...
            if (encodeLayerData) {
                ...
                for (int y = 0; y < l.getHeight(); y++) {
                    for (int x = 0; x < l.getWidth(); x++) {
                        Tile tile = tl.getTileAt(x + (int)bounds.x,
                                y + (int)bounds.y);
                        int gid = 0;
                ...
                for (int y = 0; y < l.getHeight(); y++) {
                    for (int x = 0; x < l.getWidth(); x++) {
                        Tile tile = tl.getTileAt(x + (int)bounds.x, y + (int)bounds.y);
                        int gid = 0;
